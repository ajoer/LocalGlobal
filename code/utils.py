...
def save_to_json(language, location, dictionary): 
	''' save JSON dump to file '''

	directory_name = f"data/covid19/{location}/"
	mkdirectory(directory_name)
	
	file_name = f"{language}.json"
	with open(directory_name + file_name, 'w', encoding='utf8') as outfile:
